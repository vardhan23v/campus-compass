  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[var(--bg-primary)] px-4 py-24 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-1/2 left-1/2 h-[500px] w-[500px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[var(--accent)]/10 blur-[100px]" />
      </div>
      ...
      <div className="glass w-full max-w-md rounded-3xl p-8 sm:p-12 shadow-2xl">
        <div className="mb-8 text-center">
          ...
          <p className="text-[var(--text-secondary)] mt-2">Join CampusCompass to save and compare colleges</p>
        </div>
